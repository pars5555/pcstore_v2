...
<div id="order_collapse_expande_button^{$orderInfo->getId()}" class="order_slide_btn f_order_slide_btn">
    <span class="osb_show">{$ns.lm->getPhrase(672)}</span>
    <span class="osb_hide">Hide</span>
</div>