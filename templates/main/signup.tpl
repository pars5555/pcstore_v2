        ...
        <div class="sign_up_wrapper">
            <form role="form" method="post" action="{$SITE_PATH}/dyn/main/do_signup" autocomplete="off">
                ...
                <div class="form-group">
                    <label class="input_label label" for="sign_up_first_name_input">First Name</label>
                ...
                <div class="form-group">
                    <label class="input_label label" for="sign_up_last_name_input">Last Name</label>
                ...
                <div class="form-group">
                    <label class="input_label label" for="sign_up_phone_input">Phone</label>
                    <input id="sign_up_phone_input" type="text" class="text" placeholder="Phone" name="phone"  value="{$ns.req.phone|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label label" for="sign_up_email_address_input">Email address</label>
                ...
                <div class="form-group">
                    <label class="input_label label" for="sign_up_password_input">Password</label>
                ...
                <div class="form-group">
                    <label class="input_label label" for="sign_up_confirm_password_input">Confirm Password</label>
