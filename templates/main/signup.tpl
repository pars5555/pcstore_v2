        ...
        <div class="sign_up_wrapper">
            <form role="form" method="post" action="{$SITE_PATH}/dyn/main/do_signup" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text" placeholder="First Name" name="first_name" value="{$ns.req.first_name|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="exampleInputEmail1">Last Name</label>
                    <input type="text" class="form-control text" placeholder="Last Name" name="last_name" value="{$ns.req.last_name|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="exampleInputEmail1">Phone</label>
                    <input type="text" class="form-control text" placeholder="Phone" name="phone"  value="{$ns.req.phone|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="exampleInputEmail1">Email address</label>
                    <input type="email" placeholder="Enter email" class="form-control text" name="email"  value="{$ns.req.email|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="exampleInputPassword1">Password</label>
                    <input type="password" placeholder="Password" class="form-control text" name="password"  value="{$ns.req.password|default:''}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="exampleInputPassword1">Confirm Password</label>
                    <input type="password" placeholder="Password" class="form-control text" name="repeat_password"  value="{$ns.req.repeat_password|default:''}">
                </div>
