                ...
                {foreach from=$ns.allCompanies item=company name=cl}
                    ...
                    <div class="company_container">
                        ...
                        <div class="company_confirm">
                            ...
                            {if ($ns.userLevel === $ns.userGroupsAdmin || $ns.userLevel === $ns.userGroupsCompany || $ns.userLevel === $ns.userGroupsServiceCompany || ($ns.userLevel === $ns.userGroupsUser && in_array($companyId,$ns.userCompaniesIdsArray)))}
