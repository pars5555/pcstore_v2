        ...
        <div class="current-user-info">
            <form role="form" method="post" action="{$SITE_PATH}/dyn/company/do_update_profile" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text" id="companyName" name="name" placeholder="{$ns.lm->getPhrase(9)}" value="{$ns.customer->getName()}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="companyWebsite">{$ns.lm->getPhrase(11)}</label>
                    <input type="url" class="form-control text" id="companyWebsite" name="url" placeholder="{$ns.lm->getPhrase(11)}" value="{$ns.customer->getUrl()}">
                </div>
                <div class="form-group">
                    <label class="input_label" for="companyDealersAccessKey">{$ns.lm->getPhrase(30)}</label>
                    <input type="text" class="form-control text" id="companyDealersAccessKey"  placeholder="{$ns.lm->getPhrase(30)}" name="access_key" value="{$ns.customer->getAccessKey()}">
                </div>
                <div class="form-group">
