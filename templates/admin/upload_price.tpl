<div class="container_upload_price">
    ...
    <div class="table_striped admin_companies_list">
        ...
        {foreach from=$ns.allCompaniesDtos item=companyDto}
            <a class="table-row" href="{$SITE_PATH}/admin/uploadprice/{$companyDto->getId()}" style="{if isset($ns.selectedCompanyDto) && $ns.selectedCompanyDto->getId()==$companyDto->getId()}color:red{/if}">
